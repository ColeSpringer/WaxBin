...
// identifier-normalized the way the store normalized them before commit (barcode and
// country both dispatch through NormalizeIdentifierField), so the fanned tag always
// carries the stored form. A value
